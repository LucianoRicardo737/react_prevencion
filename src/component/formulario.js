...
const Formulario=()=> {
    ...
    return(
        ...
        <div className='items-personas'>
           <img src={Personaje1} alt='Prevencion Salud'/>
          <img src={Personaje2} alt='Prevencion Salud'/>
          <img src={Personaje3} alt='Prevencion Salud'/>
          <img src={Personaje4} alt='Prevencion Salud'/>
            </div>
        </section>  
